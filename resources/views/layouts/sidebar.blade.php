<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
            <div class="flex justify-center mt-3">
                <div class="flex items-center">
                    <img src="../images/E6BEB01C-90B0-4CB2-85D0-ADDE4D30E38B__1_-removebg-preview-300x239.png" alt decoding="async" loading="lazy" width="150">
                </div>
            </div>
            ...
            <nav>
                ...
                <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Route::currentRouteNamed('admin.contacts.index') ? 'active' : '' }} " href="{{ route('admin.contacts.index')}}">
